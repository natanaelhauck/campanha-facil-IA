...
function buildPromptContext(form: CampaignFormData) {
...
- Se um campo opcional não estiver nos dados, não mencione esse campo e não invente a informação.
- Se houver tom de comunicação, adapte textos, legendas e WhatsApp a esse tom sem exagerar e sem criar promessas.
- Se o usuário informou que já tem fotos ou vídeos, recomende como selecionar e reaproveitar esse material. Se informou que tem pouco material ou ainda não tem, recomende produções simples com celular, luz natural e cenário real.
- Se a disponibilidade para responder WhatsApp for baixa ou indefinida, inclua preparo do atendimento, respostas salvas e expectativa realista de tempo de resposta.
- Se houver principal dificuldade atual, use esse contexto para priorizar próximos passos, criativos, WhatsApp e métricas simples.
- Para criativos, pense como um guia de produção para leigos: objetivo da peça, cena, materiais necessários, passos de gravação ou foto, montagem no Canva ou editor similar e erros a evitar.
- Para o plano de 7 dias, organize uma rotina simples depois da geração: revisar oferta, preparar canal, produzir criativos, organizar textos, configurar campanha, acompanhar sinais e decidir manter, ajustar ou pausar sem aumentar verba automaticamente.
...
- creativeIdeas: sugira de 3 a 4 fotos ou vídeos simples e reais que o negócio consiga produzir, considerando se já existem fotos ou vídeos disponíveis.
...
- prePublishChecklist: escreva de 5 a 6 verificações objetivas antes de publicar. Inclua canal funcionando, disponibilidade realista para responder, oferta clara, foto ou vídeo real, orçamento sustentável por pelo menos 7 dias e localização ou público revisado, quando aplicável.
...
- creativePack: entregue exatamente 3 criativos diferentes e possíveis de produzir por uma pessoa leiga. Para cada um, defina título, formato, objetivo do criativo, ideia visual, guia de cena, materiais necessários, dica de layout no Canva ou editor similar, passos de gravação/foto/montagem, texto curto sobre a peça, legenda pronta, CTA, prompt visual em português, dica de produção, erros a evitar e um briefing pronto para copiar. Varie entre imagem, Story/Reels ou vídeo curto quando isso fizer sentido para o canal. O aiImagePrompt é apenas um briefing; não diga que uma imagem foi criada.
- whatsappScript: escreva cinco respostas naturais e curtas: primeira resposta, resposta sobre preço, resposta para hesitação, fechamento leve e follow-up sem insistência. Não invente valores ausentes; use marcações simples como "[informe o valor]" quando necessário. Se WhatsApp for o canal principal, adapte cada resposta à oferta, ao tom de comunicação informado e à disponibilidade de atendimento.
- simpleMetricsGuide: explique de 3 a 5 métricas para observar, de 2 a 4 bons sinais, de 2 a 4 sinais de alerta, quando esperar e quando ajustar. Priorize conversas, qualidade dos contatos e a dificuldade atual informada. Não trate clique isolado como venda e não recomende aumento automático de verba.
- sevenDayActionPlan: entregue exatamente 7 itens, de "Dia 1" a "Dia 7". Cada dia deve ter título, objetivo, 2 a 4 tarefas curtas, resultado esperado como entrega prática e um cuidado. Dia 1 deve revisar oferta e preparar canal; Dia 2 produzir criativos; Dia 3 organizar textos e materiais; Dia 4 configurar campanha simples; Dia 5 acompanhar primeiros sinais; Dia 6 comparar criativos e conversas; Dia 7 decidir manter, ajustar ou pausar. Use objetivo, canal, orçamento, experiência, fotos/vídeos, disponibilidade no WhatsApp, dificuldade atual e pacote de criativos. Não recomende aumento automático de orçamento.
